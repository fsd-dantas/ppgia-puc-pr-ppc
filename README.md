...
Três missionários e três canibais devem atravessar um rio usando um bote com
capacidade para no máximo duas pessoas. Restrição: em nenhuma margem o número
de canibais pode superar o número de missionários (quando houver missionários).
